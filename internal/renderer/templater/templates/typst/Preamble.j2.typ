...
#show: rendercv.with(
  ...
  colors-body: {{ design.colors.body }},
  colors-name: {{ design.colors.name }},
  colors-headline: {{ design.colors.headline }},
  colors-connections: {{ design.colors.connections }},
  colors-section-titles: {{ design.colors.section_titles }},
  colors-links: {{ design.colors.links }},
  colors-footer: {{ design.colors.footer }},
  colors-top-note: {{ design.colors.top_note }},
