...
- Email: [alice.chen@email.com](mailto:alice.chen@email.com)
- Location: San Francisco, CA
- Website: [alicechen.dev](https://alicechen.dev/)
- LinkedIn: [alicechen](https://linkedin.com/in/alicechen)
...
# Experience
## **Stripe**, Staff Software Engineer
...
**Databases:** PostgreSQL, Redis, DynamoDB, BigQuery, Cassandra

**Tools:** Git, CI/CD, Prometheus, Grafana, Datadog
