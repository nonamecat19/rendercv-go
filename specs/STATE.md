...
| 14 | Lua-scripted custom themes (D-002) + the two folder messages | [014](014-lua-custom-themes/spec.md) | **started** — fallback, sandbox and the option layer are met; validating a *newly declared* option is not written | 3 / 4 criteria |
