...
| 14 | Lua-scripted custom themes (D-002) + the two folder messages | [014](014-lua-custom-themes/spec.md) | **criteria met, NOT verified and NOT wired** — the four acceptance criteria pass on unit tests; no fresh-context pass, no corpus case, and the pipeline does not yet look for a theme script | 4 / 4 criteria |
